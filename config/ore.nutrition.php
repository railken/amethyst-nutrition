...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\Nutrition\Nutrition::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\Nutrition\NutritionManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\Nutrition\NutritionRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\Nutrition\NutritionSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\Nutrition\NutritionValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\Nutrition\NutritionAuthorizer::class,
